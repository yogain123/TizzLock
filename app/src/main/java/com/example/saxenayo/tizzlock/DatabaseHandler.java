...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public static final String KEY_TIZZKEY = "tizzkey";

    public static final String CREATE_TABLE="CREATE TABLE " + TABLE_REGISTER + "("
            + KEY_ID + " INTEGER PRIMARY KEY," + KEY_NAME + " TEXT,"+KEY_USER_NAME + " TEXT,"+KEY_EMAIL_ID+ " TEXT,"
            + KEY_TIZZKEY + " TEXT " + ")";
    ...
    // code to add the new register
    {
        ...
        values.put(KEY_USER_NAME, registerdata.getUsername()); // register last name
        values.put(KEY_PASSWORD,registerdata.getPassword());  //register password
        values.put(KEY_EMAIL_ID, registerdata.getEmailid());//register email id
        values.put(KEY_TIZZKEY, registerdata.getTizzkey());
        // Inserting Row
